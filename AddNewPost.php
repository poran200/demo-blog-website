...
<footer class="bg-dark text-white">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="lead text-center">Inspired By | Mr. Md. Mijanur Rahman | Assistant Professor Southeast
                    University
                    <br>Developed By | Poran Chowdury | <span id="year"></span> &copy; ----All right
                    Reserved.</p>
            </div>
        </div>
    </div>
